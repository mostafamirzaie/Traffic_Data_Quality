...
class Data {
    ...
    public static void main(String[] args) throws SQLException, IOException {
        ...
        while (SegmentsId.next()) {
            ...
            BufferedReader br = new BufferedReader(new FileReader("E:/Mirzaie/flink-1.11.2/Grid/Experiments/Traffic_Train/Segments/train_"+id+".csv"));
            br.readLine();
            while ((line = br.readLine()) != null){
                String[] l = line.split(",");
                double preCount = Double.parseDouble(l[0]);
                double fCount = Double.parseDouble(l[1]);
                double count = Double.parseDouble(l[2]);
                double[][] data = new double[][]{{preCount, fCount, count}};
                ...
                //System.out.println("Eigenvectors Multiply d:");
                double [][] res = multiplyMatrices(data , eigen.vectors);
                //Matrix.print(res);
                double [][] resRes = multiplyMatrices(res , res);
                //System.out.println("Eigenvectors Multiply res2:");
                //Matrix.print(resRes);
                //System.out.println("Eigenvectors Devision d:");
            ...
            ss.append(id + "," + min + "," + max + "\n");

            System.out.println(ss);
        }
        FileWriter csvWriterOrigin = new FileWriter("E:/Mirzaie/Data Sets/2020/LNM.csv", true);
