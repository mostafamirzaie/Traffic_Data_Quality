...
public class StreamingModelBuilderContext {
       ...
       while (SegmentsId.next())
        {
            ...
            ResultSet Ans = MySql.Select("  SELECT  t1.gIndex, t2.id, t3.time as sTime, " +
                    ...
                    "                                  WHERE t2.id = "+id+" and t3.time >= Convert(datetime, '2020-01-01') and t3.time < Convert(datetime, '2020-02-01') "+
            ...
            while (Ans.next()) {
                ...
                TrainString.append(id + "," + date + ","+ fCount + ","+ weatherType +","+ visibility +","+ crash +","+ crime +","+ parkEvent +","+ count +"\n");
            }
            String filePath = "Experiments/Test Data Set/01_2020/"+id+".csv";
            FileWriter csvWriterOrigin = new FileWriter(filePath);
            csvWriterOrigin.append("id");
            csvWriterOrigin.append(",");
            csvWriterOrigin.append("date");
            csvWriterOrigin.append(",");
